...
@Autonomous (name= "RedJewelRight", group= "competition")

public class RedJewelRight extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if (completed == 1) {
                if (color == 0) {
                    ...
                    if (leftJewel.red() - 1 > rightJewel.red() && rightJewel.blue() - 1 > leftJewel.blue() && leftJewel.red()>8 && rightJewel.blue()>8) {
                        telemetry.addData("left side is red", "right side is blue");
                        color = 1;
                        curr = testGyro.getHeading();
                        target = -25;
                        // sleep(1000);
                    } else if (leftJewel.red() + 1 < rightJewel.red() && rightJewel.blue() + 1 < leftJewel.blue() && leftJewel.blue()>8 && rightJewel.red()>8) {
